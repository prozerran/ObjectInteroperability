========================================================================
    ACTIVE TEMPLATE LIBRARY : ObjectCom Project Overview
========================================================================

AppWizard has created this ObjectCom project for you to use as the starting point for
...
_ObjectCom.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_ObjectCom.h)
        GUID definitions                                (_ObjectCom_i.c)
        A type library                                  (_ObjectCom.tlb)
        Marshaling code                                 (_ObjectCom_p.c and dlldata.c)
ObjectCom.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named ObjectCom.pch and a precompiled types file named StdAfx.obj.
...
ObjectComps.vcproj
	...
	dlldata.c, ObjectCom_i.c and ObjectCom_p.c which are required
